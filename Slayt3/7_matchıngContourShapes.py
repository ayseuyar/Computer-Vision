...
#Şekil şablonunu veya refferans görüntüsünü yükleyin
template = cv2.imread('deneme.jpeg', 0)
cv2.imshow('Template', template)
cv2.waitKey()

#Hedef  görüntüyü eşleştirmeye çalıştırğımız şekillerle yükleyin
...
#İkinci hedef ggörüntüden konturları çıkarıyoruz
...
for c in contours:
    ...
    print(match)
    #eşleme değeri 0.15'den küçükse
    if match < 0.15:
        closest_contour = c
    else:
        closest_contour=[]
